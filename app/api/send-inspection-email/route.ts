...
EOFgit init
git add .
git commit -m "Initial mailer with CORS + OPTIONS"
git branch -M main
git remote add origin git@github.com:lukewachtel/ks-mailer.git
git push -u origin main
cd ~/Documents/ks-mailer
rm -f app/api/send-inspection-email/route.ts
cat > app/api/send-inspection-email/route.ts <<'EOF'
import { NextResponse } from 'next/server';
